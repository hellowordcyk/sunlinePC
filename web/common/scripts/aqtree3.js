    ...
    for (var itemi=0;itemi<ul.childNodes.length;itemi++) {
	    ...
	    subul = "";
            ...
            if (subul) {
                ...
                a.parentNode.style.listStyleImage = "url(/images/treenode_minus.gif)";
            }
        }
    }
}
...
function associateEL(a,ul) {
    a.onclick = function () {
        ...
        this.parentNode.style.listStyleImage = (display == "block") ? "url(/images/treenode_plus.gif)" : "url(/images/treenode_minus.gif)";
