...
function clickHandler(event) {
	//removeClass("selected") of all selected $(".accordionContent"),edited by hzx 20160922
	...
	//ignore checking options.alwaysOpen, edited by hzx 20160922
	...
	animations: {
		slide: function(options, additions) {
			options = $.extend({
				easing: "swing",
				//duration: 300
				//set lay loading as 0,edited by hzx 20160922
				duration: 0
			}, options, additions);
