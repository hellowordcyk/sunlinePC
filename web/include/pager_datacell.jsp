...
<div id="_loadbox" style="display:none; position:absolute;right:30px;top:25px;background:#CD281B;border:1px solid;color:#FFFFFF">正在查询，请等候...</div>
	 ...
	 <sc:with name="/DataPacket/Response/Data/PageInfo">
	   <b><sc:value name="PageNo"/></b> / <b><sc:value name="PageCount"/></b>
	   <sc:text attributesText="size='3' height='4' id='PageNo' onkeydown='if(window.event.keyCode == \"13\"){goPage_${param.submitDivId}();}'" default="1" name="PageNo" 
       xmlpath="/DataPacket/Response/Data/PageInfo" _class="pageno" type="int" dspName="输入页码"/>
