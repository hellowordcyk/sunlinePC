...
<div class="pageHeader">
	<form id="publicdeptlookupMultiListUnFilter_divid_pagerForm" onsubmit="return divSearch(this, 'publicdeptlookupMultiListUnFilter_divid');" action="/httpprocesserservlet"
	  method="post">
	<input type="hidden" name="sysName" value="<sc:fmt value='funcpub' type='crypto'/>"/>
	<input type="hidden" name="oprID" value="<sc:fmt value='funcpub-deptusermanager-public' type='crypto'/>"/>
	<input type="hidden" name="actions" value="<sc:fmt value='getPcmcDeptListUnfilter' type='crypto'/>"/>
	<input type="hidden" name="forward" value="<sc:fmt type='crypto' value='/funcpub/public/deptuser/deptLookupMultiUnFilterList.jsp' />"/>
	...
	<sc:hidden name="pdeptid" value="${param.pdeptid }" />
...
<div class="pageContent" id="publicdeptlookupMultiListUnFilter_divid" >
</div>