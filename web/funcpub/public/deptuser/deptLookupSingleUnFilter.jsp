...
<div class="pageHeader">
    <form id="deptlookupSingleUnFilterList_divid_pagerForm" onsubmit="return divSearch(this, 'deptlookupSingleUnFilterList_divid');"
        ...
        <input type="hidden" name="forward"
            value="<sc:fmt type='crypto' value='/funcpub/public/deptuser/deptLookupSingleUnFilterList.jsp' />" />
...
<div class="pageContent" id="deptlookupSingleUnFilterList_divid"></div>