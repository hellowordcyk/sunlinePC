...
<div class="pageHeader">
	<form id="publicuserlookupMultiUnFilterList_divid_pagerForm" onsubmit="return divSearch(this, 'publicuserlookupMultiUnFilterList_divid');" action="/httpprocesserservlet"
	  method="post">
		<input type="hidden" name="sysName" value="<sc:fmt value='funcpub' type='crypto'/>"/>
		<input type="hidden" name="oprID" value="<sc:fmt value='funcpub-deptusermanager-public' type='crypto'/>"/>
		<input type="hidden" name="actions" value="<sc:fmt value='getPcmcUserList' type='crypto'/>"/>
		<input type="hidden" name="forward" value="<sc:fmt type='crypto' value='/funcpub/public/deptuser/userLookupMultiUnFilterList.jsp' />"/>
...
<div class="pageContent" id="publicuserlookupMultiUnFilterList_divid" >
</div>