...
<div class="pageHeader">
	<form id="publicdeptlookupMultiList_divid_pagerForm" onsubmit="return divSearch(this, 'publicdeptlookupMultiList_divid');" action="/httpprocesserservlet"
	  method="post">
	...
	<input type="hidden" name="forward" value="<sc:fmt type='crypto' value='/funcpub/public/deptuser/deptLookupMultiList.jsp' />"/>
...
<div class="pageContent" id="publicdeptlookupMultiList_divid" >
</div>