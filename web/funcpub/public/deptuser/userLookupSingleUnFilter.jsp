...
<div class="pageHeader">
	<form id="userlookupSingleUnFilterList_divid_pagerForm" onsubmit="return divSearch(this, 'userlookupSingleUnFilterList_divid');" action="/httpprocesserservlet"
     method="post">
	...
	<input type="hidden" name="forward" value="<sc:fmt type='crypto' value='/funcpub/public/deptuser/userLookupSingleUnFilterList.jsp' />"/>
...
<div class="pageContent" id="userlookupSingleUnFilterList_divid" >
</div>
