	...
	<form id="pagerForm" action="/httpprocesserservlet?<%=filter %>" method="post" onsubmit="return dialogSearch(this);">
		...
		<div class="searchBar">
			<table class="searchContent" cellpadding="0" cellspacing="0" >
			    <tr>
			    	<td class="form-label">人员编号ssss</td>
			        ...
			        <td class="form-btn">
                        <ul>
                            <li>
                                ...
                                <button id="selectUserBtn" onclick="beforesubmit()" class="querybtn" jraf_initsubmit type="submit">查询</button>
                            </li>
                            <li>
...
function initselectedUserTree(){
	var selected = $("input[name='selected']",$.pdialog.getCurrent()).val();
	var selectedColumn = $("input[name='selectedColumn']",$.pdialog.getCurrent()).val();
	if(selected.trim() == ''){
		return;
	}
