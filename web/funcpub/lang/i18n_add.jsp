...
<form method="post" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone)"
        action="/httpprocesserservlet?sysName=<sc:fmt value='funcpub' type='crypto'/>&oprID=<sc:fmt value='i18nActor' type='crypto'/>&actions=<sc:fmt value='add' type='crypto'/>&forward=<sc:fmt value='/jui/callMessage.jsp' type='crypto'/>">
        ...
        <div class="pageFormContent">
            <table class="form-table" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td class="form-value">
                        <sc:text name="code" validate="alphanumeric required" attributesText="maxlength='100' minlength='4'" />
                    </td>
                </tr>
                <tr>
                    <td class="form-label">
