 ...
 *--%>
 <div class="pageHeader"  >
    <form id="pagerForm" onsubmit="return dialogSearch(this);" action="/httpprocesserservlet?=&=&=&=" method="post">
        ...
        <input type="hidden" name="actions" value="<sc:fmt value='queryUnAccreditRole' type='crypto'/>" />
        <input type="hidden" name="forward" value="<sc:fmt type='crypto' value='/funcpub/privilege/roleUnAccredit.jsp' />" />
