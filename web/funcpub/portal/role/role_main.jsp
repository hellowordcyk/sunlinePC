 ...
 *--%>
 <script>
function exportRole(){
	var url = "/download?sysName=<sc:fmt value='funcpub' type='crypto'/>&oprID=<sc:fmt value='PcmcRole' type='crypto'/>&actions=<sc:fmt value='exportRole' type='crypto'/>";
...
<div class="pageHeader">
    ...
    <form id="role_main_listid_pagerForm" onsubmit="return divSearch(this, 'role_main_listid');"  method="post"
        ...
        <input type="hidden" name="forward" value="<sc:fmt value='/funcpub/portal/role/role_main_list.jsp' type='crypto'/>"/>
        <%-- 规范： 初始化查询必加隐藏表单 --%>
        ...
        <ul class="toolBar">
            ...
            <li>
            	<a class="import" target="dialog" rel="importExcel" 
            		...
            		href="/funcpub/portal/role/role_import.jsp" >
            		<span>导入Excel</span>
            	</a>
            </li>
            <li><a class="exportExcel" href="#" onclick="exportRole()"><span>导出Excel</span></a></li>
            <li>
