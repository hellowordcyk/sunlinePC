...
<body >
	<form name="loginForm" action="/httpprocesserservlet"
		  ...
		  autocomplete="off" style="width: 50%;height: 200px;padding-bottom: 100px;padding-left: 100px;">
		...
		<div style="margin-top: 30px;border-bottom:1px solid #609ee9;width: 220px;margin-left: 60px;" >
<%--			<label for="usercode"><sc:message code="demo_add_username" default="用户名：" /></label>--%>
<%--	<label class="usercode">用户名：</label>--%>
			 <span
				style="display: inline-block;"> <input type="text" id="usercodeId" name="temp_usercode" size="20" placeholder="请输入用户名"
													   class="login_input" onkeyup="cleanSpan(this)" value="${param.ucode }"
													   onkeydown="enter(this,'password');" style="outline: none;border: none" />
				</span>
		</div>

		<div style="margin-top: 30px;border-bottom:1px solid #609ee9;width: 220px;margin-left: 60px;"  >
<%--			<label for="userpwd"><sc:message code="demo_add_pwd" default="密&nbsp;&nbsp;&nbsp;码："></sc:message></label>--%>
<%--			<label class="userpwd">密码：</label>--%>
			...
			<input type="hidden" name="jraf_password" /> <span
				id="passwordSpan" style="display: inline-block;"> <!--修改此处请修改js中"设置浏览器不记住密码"，"兼容火狐不记住密码"相应的代码  -->
					<input id='password' type='text' size="20" placeholder="请输入密码"
						   ...
						   onkeyup="cleanSpan(this)" onkeydown="enter()" style="outline: none;border: none" />
				</span>
		</div>
		<div class="login_bar" style="display: flex;justify-content: center;align-items: center;width: 300px">
			<button class="login_btn" type="button" name="btnsubmit"
					onclick="checkLogin(true)" style="width: 30%">登录</button>
			<button class="button" type="button"
					onclick="outSide()" style="width: 30%;height: 36px;margin-left: 10%;">退出</button>
		</div>
	</form>
</body>
<script>
