                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td width="100%" colspan="2">
                                    <sc:button value="新增子部门" _class="add" onclick="doAdd();"/>
                                    <sc:button value="修改" _class="edit" onclick="doUpdate();"/>
...
function viewDeptUsers(deptid){
    ...
    ajax.loadPageTo('/pcmc/sm/userListView.so',reqparams, 'userlist');
}
...
function setDeptValue(dept)
{
    ...
    $('deptname').update(dept.deptname == null || dept.deptname == 'null' ? "": dept.deptname);
    $('linkman').update(dept.linkman == null || dept.linkman == 'null' ? "": dept.linkman);
    $('phone').update(dept.phone == null || dept.phone == 'null' ? "": dept.phone);
    $('remark').update(dept.remark == null || dept.remark == 'null' ? "": dept.remark);
}
function doAdd()
{
