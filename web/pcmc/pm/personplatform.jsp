...
<div id="index-header">
    ...
    <div id="header-toolbar">
        <span valign="center" class="password"><a href="#" onClick="">修改密码</a></span>
...
<div id="index-container">
    <div class="index-tab">
        <ul>
            <li><a href="/pcmc/pm/personindex.jsp"><span>系统入口</span></a></li>
            <li class="current"><a href="#"><span>我的工作台</span></a></li>
        </ul>
    </div>
    <div class="index-content">
        <div class="index-panel-content">
            <div class="index-panel-title">最新通知</div>
            <div class="index-panel-container">
                <ul>
                    <li><a link="#">长亮科技入选“国家火炬计划软件产业骨干企业” </a><span class="new"></span></li> 
                    <li><a link="#">长亮科技二代支付系统强势挺进内蒙市场 </a></li>
                    <li><a link="#">长亮科技惊艳亮相“SOA中国论坛――2011平台到云” </a></li>
                    <li><a link="#">长亮科技助力恒丰银行全面布局农村金融市场 </a></li>
                    <li><a link="#">国家科技部软件产业处副处长路平一行到访长亮科技 </a></li>
                    <li><a link="#">长亮科技入选“国家火炬计划软件产业基地骨干企业”    </a></li>
                    <li><a link="#">长亮科技二代支付系统强势挺进内蒙市场</a></li>
                </ul>
            </div>
        </div>
        <div class="index-panel-content">
            <div class="index-panel-title">任务提示</div>
            <div class="index-panel-container">
                <ul>
                    <li><a link="#">长亮科技入选“国家火炬计划软件产业骨干企业” </a><span class="new"></span></li> 
                    <li><a link="#">长亮科技二代支付系统强势挺进内蒙市场 </a></li>
